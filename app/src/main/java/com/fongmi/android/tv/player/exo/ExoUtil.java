...
public class ExoUtil {
    ...
    private static RenderersFactory buildRenderersFactory(int renderMode, boolean audioPrefer, boolean videoPrefer) {
        ...
        // setFfmpegAudioPrefer/setFfmpegVideoPrefer/setEnableDecoderFallback/setEnableDv7HevcFallback
        // belong to the fongmi media3 fork's DefaultRenderersFactory, not present in the local
        // third_party/maven. Keep the standard extension renderer mode (enables ffmpeg via nextlib).
